/**
 * Copyright 2017 Rebeca Bárcena Orero and Jesús Durán Hernández
 * 				  <rebeca.barcena.o@gmail.com> <jdhez.14@gmail.com>
 *
...
void *funcionBoton(){
	...
	if(value!=0){
		...
		if(value==0){
			...
			ev3_command_motor_by_name(the_motor, COMMANDS_STRING[STOP]);
			ev3_reset_motor(the_motor);
